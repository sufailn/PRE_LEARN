...
SECRET_KEY = 'dsjfnhsodfu9w3ru02938-r2jk3f-923r-230fn2reowbv02bie4jbg-q'  # Consider using your secret key
...
EMAIL_HOST_USER = os.environ.get('admin@pl.com') 
EMAIL_HOST_PASSWORD = os.environ.get('1234')
EMAIL_USE_TLS = True
